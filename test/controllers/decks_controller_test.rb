...
class DecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post decks_url, params: { deck: { deckId: @deck.deckId, faction: @deck.faction, userId: @deck.userId } }
    end
  ...
  test "should update deck" do
    patch deck_url(@deck), params: { deck: { deckId: @deck.deckId, faction: @deck.faction, userId: @deck.userId } }

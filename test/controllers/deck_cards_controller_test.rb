...
class DeckCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deck_card" do
    assert_difference('DeckCard.count') do
      post deck_cards_url, params: { deck_card: { cardId: @deck_card.cardId, deckCardId: @deck_card.deckCardId, deckId: @deck_card.deckId } }
    end
  ...
  test "should update deck_card" do
    patch deck_card_url(@deck_card), params: { deck_card: { cardId: @deck_card.cardId, deckCardId: @deck_card.deckCardId, deckId: @deck_card.deckId } }
